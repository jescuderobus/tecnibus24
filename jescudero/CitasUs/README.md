...
```
cd existing_repo
git remote add origin http://150.214.182.194:8069/tecnibus9/CitasUs.git
git branch -M main
...
- [ ] [Set up project integrations](http://150.214.182.194:8069/tecnibus9/CitasUs/-/settings/integrations)
