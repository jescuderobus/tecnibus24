;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="7ba0157dc4b436011533c7291a3c92bd";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["zqsOhdEHYbCX"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["zqsOhdEHYbCX"].options={"anonymizeIp":false,"id":"UA-54092560-1","social":true};;CloudflareApps.installs["zqsOhdEHYbCX"].URLPatterns=["^pannellum.org/?.*$","^www.pannellum.org/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['zqsOhdEHYbCX'].URLPatterns)){(function(){var options=CloudflareApps.installs['zqsOhdEHYbCX'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("zqsOhdEHYbCX"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
