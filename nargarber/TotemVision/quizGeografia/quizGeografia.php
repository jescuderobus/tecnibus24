...
<html ⚡>
  <head>
    ...
    <script>
      ...
      setTimeout(function() {
          window.location.href = 'quizGeografia.php?' + new Date().getTime();
      }, 30000);
    
    </script>


    <title>Quiz Geografía</title>
...
$jsons = ["quizGeografia_paises.json", "quizGeografia_china.json", "quizGeografia_eeuu.json","quizGeografia_europa.json"];
...
$paisAleatorio = $data['geografia'][array_rand($data['geografia'])];
    ...
    <amp-story standalone
      ...
      <amp-story-page id="cover" auto-advance-after="3s">
        <amp-story-grid-layer template="fill">
          <amp-img src="../../../SHARED/imagenes/quizziCoverGeografia.jpg"
